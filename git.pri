...
qscm.commands += -e \"s%$$shell_quote(${QSCM_VERSION})%$${QSCM_VERSION}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_SEMVER})%$${QSCM_SEMVER}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_SEMVER_MAJ})%$${QSCM_SEMVER_MAJ}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_SEMVER_MIN})%$${QSCM_SEMVER_MIN}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_SEMVER_PAT})%$${QSCM_SEMVER_PAT}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_SEMVER_SUFFIX})%$${QSCM_SEMVER_SUFFIX}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_HASH})%$${QSCM_HASH}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_BRANCH})%$${QSCM_BRANCH}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_DISTANCE})%$${QSCM_DISTANCE}%g\"
qscm.commands += -e \"s%$$shell_quote(${QSCM_PRETTY_VERSION})%$${QSCM_PRETTY_VERSION}%g\"
unix {
